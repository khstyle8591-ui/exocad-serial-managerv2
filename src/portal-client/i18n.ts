...
const T = {
  ko: {
    ...
    // Server error codes
    invalid_credentials: '입력하신 정보가 일치하지 않습니다.',
    pw_too_short: '비밀번호는 8자 이상이어야 합니다.',
    pw_no_uppercase: '대문자를 포함해야 합니다.',
    pw_no_lowercase: '소문자를 포함해야 합니다.',
    pw_no_number: '숫자를 포함해야 합니다.',
    login_id_taken: '이미 사용 중인 로그인 ID입니다.',
    invalid_email: '올바른 이메일 형식을 입력해주세요.',
    invalid_email2: '이메일 2의 형식이 올바르지 않습니다.',
    duplicate_email2: '이메일 2는 이메일과 동일할 수 없습니다.',
    invalid_language: '유효하지 않은 언어입니다.',
    invalid_current_password: '현재 비밀번호가 일치하지 않습니다.',
    serial_required: '시리얼을 입력해주세요.',
    serial_not_found: '시리얼을 찾을 수 없습니다. 입력을 확인하거나 PM에 문의해주세요.',
    identity_mismatch: '입력한 시리얼의 고객 정보와 계정 정보가 일치하지 않습니다. 이메일, 연락처, 이름을 확인해주세요.',
    serial_not_owned: '본인 소유의 시리얼이 아닙니다.',
    invalid_package: '유효하지 않은 패키지입니다.',
    serial_already_cancelled: '이미 취소된 시리얼입니다.',
    serial_already_expired: '이미 만료된 시리얼입니다. 재갱신 신청을 이용해주세요.',
  },
  en: {
    ...
    exocad_id_label: 'My.exocad ID',
    email2_label: 'Email 2 (extra recipient, optional)',
    ...
    pw_no_uppercase: 'Must include an uppercase letter.',
    pw_no_lowercase: 'Must include a lowercase letter.',
    pw_no_number: 'Must include a number.',
    login_id_taken: 'Login ID already in use.',
    invalid_email: 'Please enter a valid email address.',
    invalid_email2: 'Email 2 is not a valid email address.',
    duplicate_email2: 'Email 2 cannot be the same as your email.',
    invalid_language: 'Invalid language.',
    invalid_current_password: 'Current password is incorrect.',
    serial_required: 'Please enter a serial number.',
    serial_not_found: 'Serial not found. Please check your input or contact your PM.',
    identity_mismatch: "The serial's customer info does not match your account. Please check your email, phone, or name.",
    serial_not_owned: 'This serial does not belong to your account.',
    invalid_package: 'Invalid package.',
    serial_already_cancelled: 'This serial has already been cancelled.',
    serial_already_expired: 'This serial has already expired. Please submit a renewal resume request.',
  },
  ja: {
    ...
    pw_too_short: 'パスワードは8文字以上が必要です。',
    pw_no_uppercase: '大文字を含める必要があります。',
    pw_no_lowercase: '小文字を含める必要があります。',
    pw_no_number: '数字を含める必要があります。',
    login_id_taken: 'このログインIDはすでに使用されています。',
    invalid_email: '正しいメールアドレスを入力してください。',
    invalid_email2: 'メール2の形式が正しくありません。',
    duplicate_email2: 'メール2はメールアドレスと同じにできません。',
    invalid_language: '無効な言語です。',
    invalid_current_password: '現在のパスワードが正しくありません。',
    serial_required: 'シリアル番号を入力してください。',
    serial_not_found: 'シリアルが見つかりません。入力を確認するか、PMにお問い合わせください。',
    identity_mismatch: 'シリアルの顧客情報とアカウント情報が一致しません。メール、電話番号、お名前をご確認ください。',
    serial_not_owned: 'このシリアルはあなたのアカウントに属していません。',
    invalid_package: '無効なパッケージです。',
    serial_already_cancelled: 'このシリアルはすでにキャンセルされています。',
    serial_already_expired: 'このシリアルはすでに期限切れです。更新再開申請をご利用ください。',
  },
} as const;

...
const DEFAULT_SETTINGS: AppSettings = {
  ...
  renewal_action_keywords: ['stop renewal', 'cancel', 'cancellation', '갱신 중단', '갱신중단', '해지', '취소', '更新停止', '解約'],
  ...
  renewal_keywords: ['stop renewal', 'cancel', 'cancellation', '갱신 중단', '갱신중단', '해지', '취소', '更新停止', '解約'],
